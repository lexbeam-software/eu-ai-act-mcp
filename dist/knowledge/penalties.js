...
const penaltyTiers = [
    {
        ...
        article: "Art. 99(3)",
        description: "Non-compliance with the prohibition of AI practices under Art. 5. The fine is up to EUR 35 million or, if the offender is an undertaking, up to 7% of total worldwide annual turnover in the preceding financial year, whichever is higher.",
        applicableTo: [
...
const smeReductions = [
    {
        ...
        description: "For SMEs including startups, each fine referred to in Art. 99 is the lower of the two amounts (fixed amount or turnover percentage), providing a proportionate cap.",
        article: "Art. 99(6)",
        details: "When calculating fines for SMEs and startups, the applicable amount is whichever is lower: the fixed EUR cap or the turnover-based percentage. This effectively caps fines at the lower threshold rather than the higher one, as applies for larger undertakings.",
    },
    {
        entityType: "EU institutions, bodies, offices, and agencies",
        description: "Where an EU institution, body, office, or agency falls within the scope of this Regulation, the European Data Protection Supervisor may impose fines. Maximum fine levels align with the tiers above.",
        article: "Art. 100",
        details: "The EDPS enforces the AI Act against EU-level bodies. The tier structure mirrors Art. 99 but enforcement and appeal procedures follow EDPS-specific rules.",
    },
];
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
export function getPenaltyTier(violationType) {
    const mapping = {
