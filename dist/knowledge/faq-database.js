...
export const faqDatabase = [
    ...
    },
    {
        ...
        answer: "Very likely yes. Annex III(4) covers AI systems used in employment, workers management, and access to self-employment. This includes recruitment and CV screening, candidate evaluation and interview analysis, promotion and termination decisions, task allocation based on behaviour or traits, and monitoring/evaluation of work performance. The Art. 6(3) exception may apply if the tool performs only narrow procedural tasks (e.g. formatting CVs) without materially influencing decisions. Document your assessment either way.",
    ...
    },
    {
        ...
        answer: "Yes, if you are a provider of a high-risk AI system. Art. 49(1) requires providers (or their authorised representatives) to register themselves and the system in the EU database before placing it on the market or putting it into service. Deployers who are public-law bodies or act on behalf of public authorities must also register (Art. 49(3)). Providers relying on the Art. 6(3) exception must still register and document their exception assessment (Art. 49(2)). The EU database is publicly accessible for transparency purposes (Art. 71).",
...
//# sourceMappingURL=faq-database.js.map