...
export const digitalOmnibus = {
    ...
    description: "European Commission proposal to simplify reporting and compliance obligations across the AI Act, GDPR, NIS2, DORA, and other digital regulations. Part of the broader EU simplification agenda. NOT YET ADOPTED - still a legislative proposal going through ordinary legislative procedure.",
    keyChanges: [
    ...
    impactOnAIAct: "If adopted, the Digital Omnibus could significantly reduce the scope of high-risk classification and ease compliance burdens. However, as a proposal only (December 2025), organisations should NOT rely on these changes for current compliance planning. Continue preparing against the current regulation text.",
};
// ---------------------------------------------------------------------------
// Helper Function
// ---------------------------------------------------------------------------
