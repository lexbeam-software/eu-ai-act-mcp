import { legalStatusInputSchema, legalStatusOutputSchema, } from "../schemas/legal-status.js";
import { KNOWLEDGE_VERSION, LAST_OMNIBUS_VERIFICATION, digitalOmnibus, omnibusSources, } from "../knowledge/deadlines.js";
function allStatusItems() {
    return [
        {
            ...
            status_note: "Current law still applies from 2 August 2026. The 7 May 2026 provisional agreement would shift Annex III high-risk obligations to 2 December 2027 if formally adopted.",
        ...
        },
        {
            ...
            binding_status: "current_law",
            status_note: "Current law still applies from 2 August 2027. The provisional agreement would shift Annex I high-risk obligations to 2 August 2028 if formally adopted.",
        ...
        },
        {
            ...
            binding_status: "current_law",
            status_note: "Current law still applies from 2 August 2026. The provisional agreement would shift Article 50(2) watermarking/output-detection timing to 2 December 2026 if formally adopted.",
        ...
        },
        {
            ...
            status_note: "GPAI obligations have applied since 2 August 2025. AI Office enforcement powers and fines start 2 August 2026. These GPAI dates are unchanged in the provisional agreement.",
        ...
        },
        {
            ...
            provisional_date_if_adopted: "2026-12-02",
            binding_status: "in_effect",
            status_note: "Article 5 prohibited practices are already in effect. The provisional agreement would add AI systems for non-consensual sexual/intimate content and CSAM, with compliance by 2 December 2026 if adopted.",
...
function matchesArea(item, area) {
    ...
    return ((area === "annex_iii" && haystack.includes("annex iii")) ||
...
export function registerLegalStatusTool(server) {
    server.registerTool("euaiact_get_legal_status", {
        ...
        const output = {
            ...
            formal_adoption_status: `${digitalOmnibus.status}: provisional political agreement reached on ${digitalOmnibus.provisionalAgreementDate}; not formally adopted or published in the Official Journal as of ${digitalOmnibus.lastVerifiedAt}.`,
...
//# sourceMappingURL=legal-status.js.map