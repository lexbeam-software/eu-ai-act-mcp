...
export const faqDatabase: FAQEntry[] = [
  ...
  },
  {
    ...
    answer:
      "The Digital Omnibus Simplification Package is a European Commission proposal tabled in December 2025 aiming to reduce compliance burden across the AI Act, GDPR, NIS2, DORA, and other digital regulations. The AI Act portion progressed to a Council/Parliament PROVISIONAL POLITICAL AGREEMENT on 2026-05-07. The provisional agreement would shift Annex III high-risk obligations from 2 Aug 2026 to 2 Dec 2027, Annex I from 2 Aug 2027 to 2 Aug 2028, and Article 50 watermarking from 2 Aug 2026 to 2 Dec 2026; it would also expand Article 5 prohibited practices (CSAM, non-consensual sexual/intimate content) and broaden sensitive-data processing for bias detection while retaining the 'strictly necessary' clause. GPAI obligations themselves and the registration mandate for exempted Annex III systems remain UNCHANGED. As of 2026-05-08, the provisional agreement is NOT adopted law: still pending formal adoption by Council and Parliament, legal/linguistic revision, and Official Journal publication. Organisations should continue preparing against the current regulation text and treat the provisional shifts as politically foreseeable but not yet binding.",
    articleReferences: [],
