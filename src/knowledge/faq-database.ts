...
export const faqDatabase: FAQEntry[] = [
  ...
  },
  {
    ...
    answer:
      "Art. 6(3) allows providers to determine that an AI system listed in Annex III is NOT high-risk if it does not pose a significant risk to health, safety, or fundamental rights. Specifically, the system must meet at least one condition: it performs a narrow procedural task, improves the result of a previously completed human activity, detects decision-making patterns without replacing human assessment, or performs a preparatory task. The provider must document this assessment before market placement and register in the EU database (Art. 49(2)). National authorities can challenge this determination.",
    articleReferences: ["Art. 6(3)", "Art. 49(2)"],
    keywords: ["Art. 6(3)", "exception", "not high-risk", "narrow procedural", "exemption", "derogation"],
