...
export const providerHighRiskObligations: Obligation[] = [
  ...
  },
  {
    ...
    deadline: "2026-08-02",
    details:
      "High-risk AI systems must allow for automatic recording of events (logs) throughout the system's lifetime. Logging must enable monitoring of operation and traceability of the system's functioning. Logs must be kept for an appropriate period, at minimum 6 months unless otherwise provided.",
    category: "documentation",
  },
  {
  ...
  },
  {
    ...
    deadline: "2026-08-02",
    details:
      "Before placing a high-risk AI system on the market or putting it into service, the provider (or authorised representative) must register the system and themselves in the EU database referred to in Art. 71. Providers relying on Art. 6(3) exceptions must also register in that database.",
...
export const deployerHighRiskObligations: Obligation[] = [
  ...
  },
  {
    ...
    deadline: "2026-08-02",
    details:
      "Monitor the operation of the high-risk AI system on the basis of the instructions for use, and inform the provider or distributor of any serious incident or malfunction. Keep logs automatically generated by the system for a period appropriate to the intended purpose, at least 6 months.",
    category: "monitoring",
  },
  {
  ...
  },
  {
    ...
    deadline: "2026-08-02",
    details:
      "Deployers using high-risk AI systems for making decisions or assisting in decisions relating to natural persons must inform those persons that they are subject to the use of a high-risk AI system. For systems in Annex III(4) (employment) this includes informing workers' representatives and affected workers.",
    category: "transparency",
  },
  {
    ...
    deadline: "2026-08-02",
    details:
      "Deployers using high-risk AI systems to make or assist decisions about natural persons must, upon request, provide clear and meaningful explanations of the role of the AI system in the decision-making procedure and the main elements of the decision taken.",
    category: "transparency",
  },
];
...
export const providerGPAIObligations: Obligation[] = [
  {
    ...
    deadline: "2025-08-02",
    details:
      "Draw up and keep up to date technical documentation of the model, including training and testing process and results, which must contain at minimum the information set out in Annex XI. Documentation must be made available to the AI Office and national competent authorities upon request.",
    category: "documentation",
  },
  {
    ...
    deadline: "2025-08-02",
    details:
      "Draw up, keep up to date, and make available information and documentation to providers of AI systems who intend to integrate the GPAI model. Must enable those providers to understand the model's capabilities and limitations and comply with their own obligations. At minimum, the information in Annex XII.",
    category: "documentation",
  },
  {
    ...
    deadline: "2025-08-02",
    details:
      "Put in place a policy to comply with Union copyright law, in particular to identify and comply with reservations of rights expressed pursuant to Art. 4(3) of Directive (EU) 2019/790 (the DSM Directive), including through state-of-the-art technologies.",
    category: "copyright",
  },
  {
