...
export const SERVER_INSTRUCTIONS = [
  ...
  "Use euaiact_get_legal_status before advising on whether Digital Omnibus dates are binding.",
  "Use euaiact_assess_fria_trigger for Art. 27 FRIA scope and euaiact_triage_serious_incident",
  "for Art. 73 serious-incident reporting buckets.",
  "",
